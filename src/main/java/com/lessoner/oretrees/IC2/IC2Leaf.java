...
public class IC2Leaf extends BlockLeaves {

	public static final String[][] leaftypes = new String[][] { { "LeafCopper", "LeafTin", "LeafUranium", "LeafLead" },
			{ "LeafCopperOpaque", "LeafTinOpaque", "LeafUraniumOpaque", "LeafLeadOpaque" } };
	public static final String[] leaves = new String[] { "Copper", "Tin", "Uranium", "Lead" };


	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(TreeOres.IC2Sapling);
	}
