...
public class IC2Sapling extends BlockSapling {
...

	{
		...
		return metadata >= 0 && metadata < ItemIC2Saplings.saplings.length ? this.iconLength[metadata] : this.iconLength[0];
	...
	public void func_149878_d(World w, int x, int y, int z, Random r) {
		...
		case 0:
			if (TreeOres.IC2trees) {
				object = new WorldGenIC2Tree(TreeOres.IC2Log, TreeOres.IC2Leaf, 0, 0, false, 4, 8, false);
			}
			break;
		case 1:
			if (TreeOres.IC2trees) {
				object = new WorldGenIC2Tree(TreeOres.IC2Log, TreeOres.IC2Leaf, 1, 1, false, 4, 8, false);
			}
			break;
		case 2:
			if (TreeOres.IC2trees) {
				object = new WorldGenIC2Tree(TreeOres.IC2Log, TreeOres.IC2Leaf, 2, 2, false, 4, 8, false);
			}
			break;
		case 3:
			if (TreeOres.IC2trees) {
				object = new WorldGenIC2Tree(TreeOres.IC2Log, TreeOres.IC2Leaf, 3, 3, false, 4, 8, false);
			}
		default:
			break;
		}
