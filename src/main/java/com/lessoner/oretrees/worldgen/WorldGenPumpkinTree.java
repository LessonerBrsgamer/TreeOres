...
public class WorldGenPumpkinTree extends WorldGenAbstractTree
{
    ...
    public WorldGenPumpkinTree(Block wood, Block leaves, int metaWood, int metaLeaves)
    {
        this(wood, leaves, metaWood, metaLeaves,false, 4, 3,false);
    }

    public WorldGenPumpkinTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
                        ...
                        for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
                        {
                            ...
                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, TreeOres.blockLeaf4, this.metaLeaves);
                                    }
                                }
                            }
                        }
