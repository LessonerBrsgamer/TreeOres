...
public class TreeStationShapedRecipes implements IRecipe
{
    ...
    public TreeStationShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public TreeStationShapedRecipes func_92100_c()
    {
