...
public class RendererPumpkinBoss extends RenderBiped {

	public static final ResourceLocation texture = new ResourceLocation(
			TreeOres.MODID + ":" + "textures/model/pumpkinboss.png");

	protected modelBoss modelEntity;
	
	private Object ModelBipedMobRightarm;

	public RendererPumpkinBoss(ModelBiped mb, float f) {
		super(mb, f);
		modelEntity = ((modelBoss) mainModel);
	}

	public void renderPumpkinBoss(EntityPumpkinBoss entity, double x, double y,
	...
	public void doRenderLiving(EntityLiving entityl, double x, double y,
			double z, float u, float v) {
		renderPumpkinBoss((EntityPumpkinBoss) entityl, x, y, z, u, v);
	...
	public void doRender(Entity entity, double x, double y, double z, float u,
		...
		renderPumpkinBoss((EntityPumpkinBoss) entity, x, y, z, u, v);
