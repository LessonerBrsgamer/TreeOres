...
import com.lessoner.oretrees.entity.EntityPumpkinBossSpawner;
...
public class ItemPumpkinSpawner extends Item{
	...
	public ItemStack onItemRightClick(ItemStack ie, World w, EntityPlayer p)
    {
        ...
        if (!w.isRemote)
        {
            w.spawnEntityInWorld(new EntityPumpkinBossSpawner(w, p));
        }
