...
public class THLeaf2 extends BlockLeaves {

	public static final String[][] leaftypes = new String[][] {
			{ "THLeafEntropy","THLeafEarth","THLeafOrder","THLeafCinnabar"},
			{ "THLeafEntropyOpaque","THLeafEarthOpaque","THLeafOrderOpaque", "THLeafCinnabarOpaque"} };
    ...
    {
        return Item.getItemFromBlock(TreeOres.ThaumcraftSapling2);
    }
