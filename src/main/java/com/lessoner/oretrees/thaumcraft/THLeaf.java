...
public class THLeaf extends BlockLeaves {

	public static final String[][] leaftypes = new String[][] {
			{ "THLeafThaumium","THLeafAir","THLeafFire", "THLeafWater"},
			{ "THLeafThaumiumOpaque","THLeafAirOpaque","THLeafFireOpaque", "THLeafWaterOpaque"} };
    ...
    {
        return Item.getItemFromBlock(TreeOres.ThaumcraftSapling);
    }
