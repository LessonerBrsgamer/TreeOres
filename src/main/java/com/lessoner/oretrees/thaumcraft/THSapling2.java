...
public class THSapling2 extends BlockSapling{
	...
	{ 
		...
		return metadata >= 0 && metadata <THISapling2.saplings.length? this.iconLength[metadata] : this.iconLength [0]; 
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r)
    {
        ...
        switch (l){
            case 0:
            	object = new WorldGenThaumcraft2(TreeOres.ThaumcraftLog2, TreeOres.ThaumcraftLeaf2, 2,0,false, 4,8, false);
            	break;
            case 1:
            	object = new WorldGenThaumcraft2(TreeOres.ThaumcraftLog2, TreeOres.ThaumcraftLeaf2, 0,1,false, 4,8, false);
            	break;
            case 2:
            	object = new WorldGenThaumcraft2(TreeOres.ThaumcraftLog2, TreeOres.ThaumcraftLeaf2, 1,2,false, 4,8, false);
            	break;
            case 3:
            	object = new WorldGenThaumcraft2(TreeOres.ThaumcraftLog2, TreeOres.ThaumcraftLeaf2, 3,3,false, 4,8, false);
            	break;
            default:
                break;
        }
