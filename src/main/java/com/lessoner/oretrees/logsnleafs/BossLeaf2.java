...
public class BossLeaf2 extends BlockLeaves {

	public static final String[][] leaftypes = new String[][] {
			{ "LeafDiamond", "LeafEmerald"},
			{ "LeafDiamondOpaque", "LeafEmeraldOpaque"} };
	public static final String[] leaves = new String[] { "Diamond", "Emerald"};
	...
	public int damageDropped(int par1, Random par2Random, int par3){
		...
		return super.damageDropped(par1) + 4;
	}
