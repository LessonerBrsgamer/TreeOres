...
import com.lessoner.oretrees.worldgen.WorldGenBossTree23;
import com.lessoner.oretrees.worldgen.WorldGenBossTree3;
import com.lessoner.oretrees.worldgen.WorldGenBossTree34;
...
public class BossSapling2 extends BlockSapling{
	...
	{ 
		...
		return metadata >= 0 && metadata <ItemBossSapling2.saplings.length? this.iconLength[metadata] : this.iconLength [0]; 
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r)
    {
        ...
        switch (l){
            case 0:
            	...
            	object = new WorldGenBossTree3(TreeOres.blockLog3, TreeOres.bossLeaf3, 0,0,false, 15,20, false);            	
            	}
            	break;
            case 1:
            	if(TreeOres.obsidiantree){
            	object = new WorldGenBossTree3(TreeOres.blockLog3, TreeOres.bossLeaf3, 1,1,false, 15,20, false);            	
            	}
            	break;
            case 2:
            	if(TreeOres.quartztree){
            	object = new WorldGenBossTree23(TreeOres.blockLog2, TreeOres.bossLeaf3, 2,2,false, 15,20, false);            	
            	}
            	break;
            case 3:
            	if(TreeOres.lapistree){
            	object = new WorldGenBossTree23(TreeOres.blockLog2, TreeOres.bossLeaf3, 3,3,false, 15,20, false);            	
            	}
            	break;
            case 4:
            	if(TreeOres.xptree){
            		object = new WorldGenBossTree34(TreeOres.blockLog3, TreeOres.bossLeaf4, 2,0,false, 15,20, false);            	
            	}
            	break;
            case 5:
            	if(TreeOres.pumpkintree){
            		object = new WorldGenBossTree34(TreeOres.blockLog3, TreeOres.bossLeaf4, 3,1,false, 15,20, false);            	
            	}
            	break;
            default:
                break;
