...
import com.lessoner.oretrees.worldgen.WorldGenGlowstoneTree;
import com.lessoner.oretrees.worldgen.WorldGenIronTree;
import com.lessoner.oretrees.worldgen.WorldGenLapisTree;
import com.lessoner.oretrees.worldgen.WorldGenObsidianTree;
import com.lessoner.oretrees.worldgen.WorldGenPumpkinTree;
import com.lessoner.oretrees.worldgen.WorldGenQuartzTree;
import com.lessoner.oretrees.worldgen.WorldGenXPTree;
...
public class NCSapling2 extends BlockSapling{
	...
	{ 
		...
		return metadata >= 0 && metadata <ItemSaplingBlocks2.saplings.length? this.iconLength[metadata] : this.iconLength [0]; 
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r)
    {
        ...
        switch (l){
            case 0:
            	...
            	object = new WorldGenGlowstoneTree(TreeOres.blockLog3, TreeOres.blockLeaf3, 0,0,false, 4,8, false);            	
            	}
            	break;
            case 1:
            	if(TreeOres.obsidiantree){
            	object = new WorldGenObsidianTree(TreeOres.blockLog3, TreeOres.blockLeaf3, 1,1,false, 4,8, false);            	
            	}
            	break;
            case 2:
            	if(TreeOres.quartztree){
            	object = new WorldGenQuartzTree(TreeOres.blockLog2, TreeOres.blockLeaf3, 2,2,false, 4,8, false);            	
            	}
            	break;
            case 3:
            	if(TreeOres.lapistree){
            	object = new WorldGenLapisTree(TreeOres.blockLog2, TreeOres.blockLeaf3, 3,3,false, 4,8, false);            	
            	}
            	break;
            case 4:
            	if(TreeOres.xptree){
            		object = new WorldGenXPTree(TreeOres.blockLog3, TreeOres.blockLeaf4, 2,0,false, 4,8, false);            	
            	}
            	break;
            case 5:
            	if(TreeOres.pumpkintree){
            		object = new WorldGenPumpkinTree(TreeOres.blockLog3, TreeOres.blockLeaf4, 3,1,false, 4,8, false);            	
            	}
            	break;
            default:
                break;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
        	iconLength[i] = p_149651_1_.registerIcon(TreeOres.MODID + ":" + "sapling" + "_" + saplings[i]);
        }
    }
