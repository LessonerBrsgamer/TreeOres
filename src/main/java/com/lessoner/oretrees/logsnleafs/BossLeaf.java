...
public class BossLeaf extends BlockLeaves {

	public static final String[][] leaftypes = new String[][] {
			{ "LeafIron", "LeafGold", "LeafCoal", "LeafRedstone" },
			{ "LeafIronOpaque", "LeafGoldOpaque", "LeafCoalOpaque",
					"LeafRedstoneOpaque", "LeafDiamondOpaque" } };
	public static final String[] leaves = new String[] { "Iron", "Gold",
			"Coal", "Redstone" };
    ...
    {
        return Item.getItemFromBlock(TreeOres.BossSapling);
    }
